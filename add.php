  ...
  elseif($typePage == 5){
      if(isset($_GET['submit'])){
          if (!empty($_GET['name']) & !empty($_GET['date'])){
			...
			$doctorInsert = $_SESSION['session_username'];
            			...
            			echo'
                              ...
                              <select name="dol" id="dol">
                                ...
                                <option value="doc">Доктор</option>
													...
													<option value="psi">Психолог</option>
													<option value="stpsi">Старший психолог</option>
                      ...
                      echo'
                          <div class="date">Дата записи: '.$date->getDateTime().'</div>
                            <form action="add.php" method="GET">
                              ...
                              <p><label for="date">Дата рождения<br><input id="data" name="date" type="text" required></label></p>
